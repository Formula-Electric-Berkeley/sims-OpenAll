...
% filename
vehiclefile = 'OpenVEHICLE Vehicles/OpenVEHICLE_SN3_120A_Low_Drag_Open Wheel.mat' ;
...
acceleration_t = acc_75m_t - acc_headstart_t;

display("Acceleration Time: " + acceleration_t + " seconds")
